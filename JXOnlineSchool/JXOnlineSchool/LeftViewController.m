...
- (void)initSubviews{
    ...
    [userLogo setImage:[UIImage imageNamed:@"icons_login_avatar"] forState:UIControlStateNormal];
    ...
    [nickBtn setImage: [UIImage imageNamed: @"side_menu_bianji"] forState: UIControlStateNormal];
    ...
    [button setImage: [UIImage imageNamed: @"side_menu_tuijian"] forState: UIControlStateNormal];
    ...
    [button1 setImage: [UIImage imageNamed: @"side_menu_lixian"] forState: UIControlStateNormal];
    [button1 setImageEdgeInsets: UIEdgeInsetsMake(-8, 20, 0, 0)];
    [button1 setTitleEdgeInsets: UIEdgeInsetsMake(0, -30, -60, 0)];
    ...
    button2.tag = 1002;
    [button2 setImage: [UIImage imageNamed: @"side_menu_kecheng"] forState: UIControlStateNormal];
    [button2 setImageEdgeInsets: UIEdgeInsetsMake(-8, 20, 0, 0)];
    [button2 setTitleEdgeInsets: UIEdgeInsetsMake(0, -30, -60, 0)];
    ...
    button3.tag = 1003;
    [button3 setImage: [UIImage imageNamed: @"side_menu_souchang"] forState: UIControlStateNormal];
    [button3 setImageEdgeInsets: UIEdgeInsetsMake(-8, 20, 0, 0)];
    [button3 setTitleEdgeInsets: UIEdgeInsetsMake(0, -30, -60, 0)];
    ...
    button4.tag = 1004;
    [button4 setImage: [UIImage imageNamed: @"side_menu_shezhi"] forState: UIControlStateNormal];
    [button4 setImageEdgeInsets: UIEdgeInsetsMake(-8, 20, 0, 0)];
    [button4 setTitleEdgeInsets: UIEdgeInsetsMake(0, -30, -60, 0)];
    ...
    button5.tag = 1005;
    [button5 setImage: [UIImage imageNamed: @"side_menu_kefu"] forState: UIControlStateNormal];
    [button5 setImageEdgeInsets: UIEdgeInsetsMake(-8, 20, 0, 0)];
    [button5 setTitleEdgeInsets: UIEdgeInsetsMake(0, -30, -60, 0)];
